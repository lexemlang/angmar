...
internal class DataCapturingAccessLexemeNodeTest {
    // PARAMETERS -------------------------------------------------------------
    ...
    companion object {
        ...
        fun checkTestExpression(node: ParserNode) {
            Assertions.assertTrue(node is DataCapturingAccessLexemeNode, "The input has not been correctly parsed")
            node as DataCapturingAccessLexemeNode
    ...
    fun `parse correct accesses`(text: String, elementType: Int, modifierType: Int, modifier2Type: Int) {
        ...
        val res = DataCapturingAccessLexemeNode.parse(parser, ParserNode.Companion.EmptyParserNode, 0)
        ...
        if (modifierType == 0 && modifier2Type == 0) {
            ...
            res as DataCapturingAccessLexemeNode
