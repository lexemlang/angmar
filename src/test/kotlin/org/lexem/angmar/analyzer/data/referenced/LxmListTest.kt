...
internal class LxmListTest {
    ...
    fun `test constructors`() {
        ...
        old.addCell(memory, LxmInteger.Num2)

        Assertions.assertEquals(1, old.size, "The size property is incorrect")
        ...
        Assertions.assertEquals(1, old.size, "The size property is incorrect")
        Assertions.assertEquals(1, new.size, "The size property is incorrect")

        new.addCell(memory, LxmInteger.Num1)

        Assertions.assertEquals(1, old.size, "The size property is incorrect")
        Assertions.assertEquals(2, new.size, "The size property is incorrect")
    }
