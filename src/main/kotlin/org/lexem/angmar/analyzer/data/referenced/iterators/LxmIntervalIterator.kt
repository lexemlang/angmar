...
internal class LxmIntervalIterator : LexemIterator {
    ...
    private constructor(memory: LexemMemory, oldVersion: LxmIntervalIterator) : super(memory, oldVersion) {
    ...
    override fun memoryShift(memory: LexemMemory) = LxmIntervalIterator(memory, oldVersion = this)
