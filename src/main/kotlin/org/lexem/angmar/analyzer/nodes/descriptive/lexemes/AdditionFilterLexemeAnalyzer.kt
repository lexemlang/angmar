...
internal object AdditionFilterLexemeAnalyzer {
    ...
    fun stateMachine(analyzer: LexemAnalyzer, signal: Int, node: AdditionFilterLexemeCompiled) {
        when (signal) {
    ...
    private fun finalizeNode(analyzer: LexemAnalyzer, lxmNode: LxmNode) {
        ...
        nodePosition.insertChildren(analyzer.memory, listOf(lxmNode), isForward = !reverse)
    }
}
