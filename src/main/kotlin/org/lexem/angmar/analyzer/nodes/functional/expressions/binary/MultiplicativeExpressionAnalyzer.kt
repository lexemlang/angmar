...
internal object MultiplicativeExpressionAnalyzer {
    ...
    fun stateMachine(analyzer: LexemAnalyzer, signal: Int, node: MultiplicativeExpressionCompiled) {
        when (signal) {
     ...
     */
    private fun operate(analyzer: LexemAnalyzer, signal: Int, position: Int, node: MultiplicativeExpressionCompiled) {
